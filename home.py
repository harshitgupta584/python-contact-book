...
class HomeWindow(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.header_label = Label(self.header_frame, style='Header.TLabel', text="My Contact Book")
        ...
        self.manage_contacts_button = Button(self.navigation_frame, text="Manage Contacts",
